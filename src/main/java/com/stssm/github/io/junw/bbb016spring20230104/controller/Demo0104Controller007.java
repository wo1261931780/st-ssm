...
public class Demo0104Controller007 {
	...
	public String getDateParams(@RequestParam Date demoDate,
		...
		System.out.println("我是实体类Demo0105Controller002中getDateParams获取的数据1:" + demoDate);
		// Thu Jan 05 00:00:00 CST 2023
		// 日期类型的数据被接收后，返回的是一个date类型的对象
		System.out.println("我是实体类Demo0105Controller002中getDateParams获取的数据2:" + demoDate2);
		System.out.println("我是实体类Demo0105Controller002中getDateParams获取的数据3:" + demoDate3);
