...
public class Demo0104Controller008 {
	...
	public String toText() {
		System.out.println("我是Demo0105Controller003中的toText方法");
	...
	public Demo0104DomainUser toJsonPojo() {
		System.out.println("我是Demo0105Controller003中的toJsonPojo方法");
		...
		System.out.println("我是返回的对象：" + demo0104DomainUser);
	...
	public List<Demo0104DomainUser> toJsonListPojo() {
		System.out.println("我是Demo0105Controller003中的toJsonListPojo方法");
		...
		System.out.println("我是返回的对象：" + demo0104DomainUserList);
		// 这里也会返回json列表数据
