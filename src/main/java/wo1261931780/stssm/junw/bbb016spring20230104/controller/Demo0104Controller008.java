...
public class Demo0104Controller008 {
	...
	public String toJumpPage() {
		log.debug("我是Demo0105Controller003中的toJumpPage方法");
		return "index.jsp";
	}
	...
	public String toText() {
		log.debug("我是Demo0105Controller003中的toText方法");
	...
	public Demo0104DomainUser toJsonPojo() {
		log.debug("我是Demo0105Controller003中的toJsonPojo方法");
		...
		log.debug("我是返回的对象：" + demo0104DomainUser);
	...
	public List<Demo0104DomainUser> toJsonListPojo() {
		log.debug("我是Demo0105Controller003中的toJsonListPojo方法");
		...
		log.debug("我是返回的对象：" + demo0104DomainUserList);
		// 这里也会返回json列表数据
